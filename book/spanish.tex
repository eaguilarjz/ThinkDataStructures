...
de este material y omito o quito importancia al resto.
...
Si no tienes una cuenta en GitHub, necesitarás crear una. Después de crear el fork, 
...
instructions in Section~\ref{codigo}.
...
In the code repository for this book (see Section~\ref{codigo}),
